  ...
  return (
    <>
      <div className="w-3/4 max-425:w-full">
        <div className="main-container py-2 px-4 rounded-xl bg-white dark:bg-[#2c303f] dark:text-white">
          <div className="text-5xl text-gray-500 font-semibold py-5 px-5">版权协议</div>

          <p>为了保持文章质量，并保持互联网的开放共享精神，保持页面流量的稳定，综合考虑下本站的所有原创文章均采用cc 协议中比较严格的<Link href="https://creativecommons.org/licenses/by-nc-nd/4.0/deed.zh" target="_blank" rel="noopener noreferrer">署名-非商业性使用-禁止演绎 4.0 国际标准</Link>。</p>
          ...
          <h2>哪些文章适于本协议？</h2>
          <p>所有原创内容均在文章标题顶部，以及文章结尾的版权说明部分展示。原创内容的非商用转载必须为完整转载且标注出处的`带有完整url链接`或`访问原文`之类字样的超链接。作为参考资料的情况可以无需完整转载，摘录所需要的部分内容即可，但需标注出处。</p>
