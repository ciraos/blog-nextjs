    ...
    <>
      <div id="recent-post" className="recent-post w-3/4 max-425:w-full">
        {posts?.map((post, index) => (
          <div key={index} className="recent-post-item w-full h-40 py-4 px-4 flex flex-col justify-center bg-white rounded-xl shadow-md hover:shadow-xl dark:bg-[#2c303f]">
