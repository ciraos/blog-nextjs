      ...
      <div className="w-full max-w-6xl py-[40px] px-[15px] my-0 mx-auto flex transition-all max-768:flex-col">
        <div id="recent-post" className="w-3/4 max-768:w-full">
          {posts?.map ((post, index) => (
            <motion.div id="recent-post-item" className="h-40 py-4 px-4 bg-white rounded-xl overflow-hidden flex flex-col justify-center transition-all max-600:w-full max-768:flex-col dark:bg-dacard" key={index}>
