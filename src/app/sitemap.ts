...
export default function sitemap(): MetadataRoute.Sitemap {
    try {
        return [
            ...
            { url: `${BASE_URL}/bangumis`, lastModified: getFixedDate(), changeFrequency: 'monthly', priority: 0.8 },
            ...
            { url: `${BASE_URL}/equiement`, lastModified: getFixedDate(), changeFrequency: 'monthly', priority: 0.8 },
            ...
            { url: `${BASE_URL}/posts/cncnet-plus-ares`, lastModified: getFixedDate(), changeFrequency: 'weekly', priority: 0.5 },
            { url: `${BASE_URL}/posts/helloworld`, lastModified: getFixedDate(), changeFrequency: 'weekly', priority: 0.5 },
            { url: `${BASE_URL}/posts/javascript-study01`, lastModified: getFixedDate(), changeFrequency: 'weekly', priority: 0.5 },
            { url: `${BASE_URL}/posts/NextjsNote`, lastModified: getFixedDate(), changeFrequency: 'weekly', priority: 0.5 },
            { url: `${BASE_URL}/posts/QQPluginNote`, lastModified: getFixedDate(), changeFrequency: 'weekly', priority: 0.5 },
